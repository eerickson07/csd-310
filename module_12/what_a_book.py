...
def show_books(_cursor):
    ...
    for book in books:
        print("Book Name: {} \n Author: {} \n Details: {}\n".format(books[0], books[1], books[2]))
...
def show_account_menu():
    try:
        ...
        print(" 1. Wishlist\n   2. Add Book\n    3. Main Menu")
        account_option = int(input(" Please select option: "))
...
def show_wishlist(_cursor, _user_id):
    ...
    "FROM wishlist" + "INNER JOIN book ON wishlist.book_id = book.book_id" + "INNER JOIN user ON wishlist.user_id + user.user_id"+
